...
const Reply = ({ reply }) => (
  <li className="list-none my-2">
    <article
      className="px-4 py-4 sm:px-6 rounded-lg bg-indigo-100 shadow"
      ...
      <div>
        <div className="flex space-x-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-sm text-gray-500">{reply.date.split("T")[0]}</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex space-x-6">
          <span className="inline-flex items-center text-sm">
            ...
            >
              ...
              <span className="font-medium text-gray-900">{reply.likes}</span>
